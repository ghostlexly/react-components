...
const JeelizResizer = (function () {
  ...
  function apply_sizeCanvas(width, height) {
    _whCanvasPx = [Math.round(_overSamplingFactor * width), Math.round(_overSamplingFactor * height)];
  ...
  const that = {
    ...
    size_canvas: function (optionsArg) {
      ...
      _domCanvas = document.querySelector("#" + options.canvasId);
      ...
      if (_isFullScreen) {
        ...
        console.log(document.querySelector("#" + options.canvasId));
